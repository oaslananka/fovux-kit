...
3. Review [Testing and Code Coverage](testing-and-coverage.md) for our CI and coverage policy.
4. Review [MCP 2025-11-25 Conformance](mcp-conformance.md) for protocol and transport support.
5. Jump to [Tool Reference](tools/dataset_inspect.md) for exact inputs, outputs, and examples.
