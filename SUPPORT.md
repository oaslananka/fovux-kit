...
Issues are triaged using these priority labels:

| Label         | Meaning                                 |
| ------------- | --------------------------------------- |
| `priority:p0` | Critical — blocks users, data loss risk |
| `priority:p1` | High — significant functionality broken |
| `priority:p2` | Medium — workaround exists              |
| `priority:p3` | Low — cosmetic or minor                 |
